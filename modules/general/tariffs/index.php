...
if (cfr('TARIFFS')) {
    ...
    <table>
        ...
        foreach ($dirs as $dir) {
            ...
            if ($tariffdata["NoDiscount" . $rulenumber] == 1) {

                $ns[$rulenumber] = "CHECKED";
            }
            if ($tariffdata["SinglePrice" . $rulenumber] == 1) {

                $sp[$rulenumber] = "CHECKED";
            }
        ...
        <table>
            ...
            <tr>
                <td>
                    <select id="dhour' . $rulenumber . '"  name="options[dhour][' . $rulenumber . ']">
                        <option>00</option>';
            $form.=tariff_time(24, $tariffdata['Time'][$rulenumbe] ['Dhour']);
            $form.=tariff_time(24, $tariffdata['Time'][$rulenumbe] ['Dhour']);

            $form .= '</select>
                        </td>
                        <td>
                            <select id="dmin' . $rulenumber . '"  name="options[dmin][' . $rulenumber . ']">
                                <option>00</option>';
            $form.=tariff_time(60, $tariffdata['Time'][$rulenumber] ['Dmin']);
            $form.=tariff_time(60, $tariffdata['Time'][$rulenumber] ['Dmin']);
